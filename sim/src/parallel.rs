...
//!
//! ## On the `unsafe` boundary IDEA.md anticipated
//!
//! IDEA.md framed Phase 2 as "disjoint `&mut` into the shared world behind a
...
/// IDEA.md's "workers self-tick". Spawned once and reused across ticks, so the
